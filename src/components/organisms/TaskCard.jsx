...
const TaskCard = ({ task, category, onToggleComplete, onEdit, onDelete, className }) => {
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="pt-1">
                    <Checkbox
                        ...
                        className={cn('transition-all duration-300', isCompleting && 'animate-pulse')}
                    />
                </div>
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {task.files_c && task.files_c.length > 0 && (
                        <div className="mt-2 flex flex-wrap gap-2">
                            ...
                            <span className="text-xs text-gray-500">{Array.isArray(task.files_c) ? task.files_c.length : 1} file(s) attached</span>
                        </div>
                    )}
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {/* Due date */}
                        {task.dueDate && (
                            <Badge variant={isOverdue ? 'high' : isDueToday ? 'medium' : 'default'} size="sm" className="flex items-center gap-1">
                                <ApperIcon name={isOverdue ? 'AlertTriangle' : 'Calendar'} className="h-3 w-3" />
