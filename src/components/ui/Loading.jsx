          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                {/* Title skeleton */}
                <div className="h-5 bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 rounded animate-pulse" style={{ width: `${Math.random() * 40 + 50}%` }}></div>
                
                {/* Description skeleton */}
                <div className="h-4 bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 rounded animate-pulse" style={{ width: `${Math.random() * 30 + 60}%` }}></div>
