...
const Upcoming = () => {
    ...
    const filterType = searchQuery ? 'search' : 'upcoming';
    ...
    return (
        <div className="flex-1 flex flex-col h-full">
            <Header title="Upcoming" onAddTask={handleAddTask} onSearch={handleSearch} showMobileMenu={false} />
            ...
            <div className="flex-1 overflow-auto p-4 lg:p-6">
                <TaskList
                    ...
                    emptyTitle={searchQuery ? 'No tasks found' : 'No upcoming tasks'}
                    emptyDescription={
                        searchQuery
                            ? `No tasks match "${searchQuery}". Try a different search term.`
                            : 'All caught up! No tasks are scheduled for the future.'
                    }
                />
            </div>
