...
const CategoryTasks = () => {
    ...
    const filteredTasks = searchQuery ? tasks.filter((task) => task.category_id_c === parseInt(categoryId)) : tasks;

    return (
        <div className="flex-1 flex flex-col h-full">
            <Header title={currentCategory?.Name || 'Category Tasks'} onAddTask={handleAddTask} onSearch={handleSearch} showMobileMenu={false} />
            ...
            <div className="flex-1 overflow-auto p-4 lg:p-6">
                <TaskList
                    ...
                    emptyTitle={searchQuery ? 'No tasks found' : `No ${currentCategory?.Name?.toLowerCase() || 'category'} tasks`}
                    emptyDescription={
                        searchQuery
