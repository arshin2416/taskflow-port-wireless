...
const FilterDropdown = ({ label = 'Filter', options = [], value, onChange, className }) => {
    ...
    return (
        <div ref={dropdownRef} className={cn('relative', className)}>
            ...
            >
                ...
                <ApperIcon name="ChevronDown" className={cn('h-4 w-4 transition-transform', isOpen && 'transform rotate-180')} />
            </button>
